...
M.setup = function()
    ...
    local accent_100 = frost_100:complement()
    local accent_200 = frost_200:complement()
    local accent_300 = frost_300:complement()
    local accent_400 = frost_400:complement()
    ...
    vim.api.nvim_set_hl(0, "Type", { fg = green:hex() })
    vim.api.nvim_set_hl(0, "String", { fg = orange:lighten(13):fade(8):hex() })
    vim.api.nvim_set_hl(0, "Function", { fg = frost_200:hex() })
    vim.api.nvim_set_hl(0, "Statement", { fg = text_200:hex() })
    vim.api.nvim_set_hl(0, "Keyword", { fg = accent_300:hex() })
