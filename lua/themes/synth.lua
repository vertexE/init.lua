...
M.setup = function(c)
    ...
    local defaults = {
        ...
        TabLineFill = { bg = colors.surface:hex() },
        ...
        LineNr = { fg = colors.gray_500:hex() },
        CursorLineNr = { fg = colors.text_100:hex() },
        CursorLine = { bg = colors.surface:lighten(3):hex() },
        Comment = { italic = true, fg = colors.steel:hex() },
        CommentItalic = { italic = true, fg = colors.steel:hex() },
        ...
        BlinkCmpMenuSelection = { bg = colors.surface:lighten(3):hex() },
        ...
        CodeLensSeparator = { fg = colors.surface:lighten(10):hex() },
        CodeLensContentIcon = { fg = colors.primary:hex(), bg = colors.surface:lighten(10):hex() },
        CodeLensContent = { italic = true, fg = colors.gray_300:hex(), bg = colors.surface:lighten(10):hex() },
        ...
        DiagnosticUnderlineInfo = { undercurl = true, sp = colors.brown:hex() },
        DiagnosticInfoTextNoBg = { fg = colors.surface:hex() },
        DiagnosticInfoTextWithBg = { fg = colors.brown:hex(), bg = colors.surface:hex(), italic = true },
        ...
        DiagnosticInfoDotOnErrorBg = { fg = colors.brown:hex(), bg = colors.surface:hex(), italic = true },
        ...
        DiagnosticInfoDotOnWarnBg = { fg = colors.brown:hex(), bg = colors.surface:hex(), italic = true },
        ...
        DiagnosticInfoDotOnInfoBg = { fg = colors.brown:hex(), bg = colors.surface:hex(), italic = true },
        ...
        DiagnosticInfoDotOnHintBg = { fg = colors.brown:hex(), bg = colors.surface:hex(), italic = true },
